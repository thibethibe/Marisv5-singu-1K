    ...
    if (logMessageType == "log:thread-name") {
      if (isValid) {
        ...
        if (data.antist_info.name !== null) {
          return api.sendMessage("[ MODE ] - Hiện tại đang kích hoạt chế độ chống thay tên nhóm", threadID, () => {
      ...
      if (data.antist.nickname === true && !(author == api.getCurrentUserID() && logMessageData.participant_id == api.getCurrentUserID())) {
        if (data.antist_info.nicknames !== null && isValid == false) {
          return api.sendMessage("[ MODE ] - Hiện tại đang kích hoạt chế độ chống thay biệt danh thành viên", threadID, () => {
      ...
      if (data.antist.boximage === true) {
        if (data.antist_info.imageSrc !== null && isValid == false) {
          ...
          return api.sendMessage("[ MODE ] - Hiện tại đang kích hoạt chế độ chống thay ảnh nhóm", threadID, async () => {
      ...
      if (!isValid && data.antist.theme == true) {
        if (data.antist_info.themeID) {
          return api.sendMessage("[ MODE ] - Hiện tại đang kích hoạt chế độ chống thay màu nhóm", threadID, () => {
      ...
      if (data.antist.emoji === true) {
        if (data.antist_info.emoji !== null && isValid == false) {
          return api.sendMessage("[ MODE ] - Hiện tại đang kích hoạt chế độ chống thay emoji nhóm", threadID, async () => {
