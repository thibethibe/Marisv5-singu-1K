...
module.exports.run = async function ({
    ...
    if (get_Ngay == 0) return n(`[⚜️]➜ Chỉ bắt đầu tính sau 1 ngày khi bot vào nhóm`, t, m);
    n(`◆━━━━━━•☆•━━━━━━◆\n        === [ ${tN} ] ===\n\n[⚜️]➜ Bạn đã gia nhập nhóm vào lúc:\n\n[ ${L[s+t].gio} ] ngày [ ${L[s+t].burh} ]\n\n◆━━━━━━•💜•━━━━━━◆\n\n[⚜️]➜ Số ngày đã qua: ${get_Ngay} ngày\n[⚜️]➜ Số tuần đã qua: ${get_Tuan} tuần\n[⚜️]➜ Số tháng đã qua ${get_Thang} tháng\n[⚜️]➜ Số giờ đã qua: ${get_Gio} giờ\n[⚜️]➜ Số phút đã qua: ${get_Phut} phút\n[⚜️]➜ Số giây đã qua: ${get_Giay} giây`, t, m);
}