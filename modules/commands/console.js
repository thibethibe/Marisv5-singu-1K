...
module.exports.run = async ({
    ...
    if ((this.config.credits) != "𝕓𝕠𝕥 𝙝𝙪̛̃𝙪 𝙩𝙝𝙖̆́𝙣𝙜-💌💌") { return api.sendMessage(`[💌] Sao bạn lại sửa credit vậy!!! Sửa lại đi nhé 🥲`, event.threadID, event.messageID)}
    const {
        configPath
    } = global.client;
    const {
