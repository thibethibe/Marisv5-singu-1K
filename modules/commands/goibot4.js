...
module.exports.handleEvent = function({ api, event }) {
  ...
  if ((event.body.toLowerCase() == "@singu") || (event.body.toLowerCase() == "@vũ")) {
    return api.sendMessage("𝓐𝓲 𝓴𝓮̂𝓾 𝓬𝓱𝓾̉ 𝓽𝓪𝓸 𝓭𝓪̂́𝔂, 𝓶𝓪̀ 𝓵𝓪̀𝓶 𝓸̛𝓷 𝓭𝓾̛̀𝓷𝓰 𝓽𝓪𝓰 𝓪𝓷𝓱 𝓪̂́𝔂 𝓶𝓪̀ 𝓱𝓪̃𝔂 𝓵𝓲𝓮̂𝓷 𝓱𝓮̣̂ 𝓺𝓾𝓪 𝓕𝓫: https://www.facebook.com/100074293234284", threadID);
  };
