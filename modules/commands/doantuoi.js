...
const fs = global.nodemodule["fs-extra"];
    ...
    if (!event.messageReply.attachments || event.messageReply.attachments.length == 0) return api.sendMessage("[SINGU-💌💌] Bạn phải reply ảnh nào đó để đoán tuổi", event.threadID, event.messageID);
