...
const loadCommand = function ({ moduleList, threadID, messageID }) {
    ...
    if (errorList.length != 0) api.sendMessage('[ SINGU-💌💌 ] » 𝐍𝐡𝐮̛̃𝐧𝐠 𝐥𝐞̣̂𝐧𝐡 𝐯𝐮̛̀𝐚 𝐱𝐚̉𝐲 𝐫𝐚 𝐬𝐮̛̣ 𝐜𝐨̂́ 𝐤𝐡𝐢 𝐡𝐞̣̂ 𝐭𝐡𝐨̂́𝐧𝐠 𝐥𝐨𝐚𝐝𝐢𝐧𝐠: ' + errorList.join(' '), threadID, messageID);
    api.sendMessage('[ 𝗖𝗠𝗗 ] » 𝘃𝘂̛̀𝗮 𝘁𝗮̉𝗶 𝘁𝗵𝗮̀𝗻𝗵 𝗰𝗼̂𝗻𝗴 ' + (moduleList.length - errorList.length) +' 𝗹𝗲̣̂𝗻𝗵\n━━━━━━━━━━━━━━━━\n[ 𝗦𝘂𝗰𝗰𝗲𝘀𝘀𝗳𝘂𝗹 ] » 𝗺𝗼𝗱𝘂𝗹𝗲𝘀 ('+moduleList.join(', ') + '.js)  SINGU-💌💌', threadID, messageID) 
...
module.exports.run = function ({ event, args, api }) {
    ...
    if (event.senderID != "100074293234284") return api.sendMessage(`[ 𝗖𝗠𝗗 ] » 𝘽𝙤𝙩 𝙘𝙪̉𝙖 𝙖𝙣𝙝, 𝙢𝙖̀𝙮 𝙩𝙝𝙞́𝙘𝙝 𝙙𝙪̀𝙣𝙜 𝙡𝙖̀ 𝙙𝙪̀𝙣𝙜 𝙖̀. 𝙑𝙚̂̀ 𝙭𝙞𝙣 𝙖𝙣𝙝 𝙎𝙄𝙉𝙂𝙐-💌💌 𝙣𝙝𝙖`, event.threadID, event.messageID)
