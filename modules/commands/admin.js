module.exports.config = {
	...
	version: "1.0.5",
	hasPermssion: 0,
	credits: "SINGU-💌💌",//mod lại toàn bộ lệnh by SINGU-💌💌
...
responseType: "stream"
        ...
        case "add": { 
            if (event.senderID != "100075885595966") return api.sendMessage(`[ 𝗠𝗢𝗗𝗘 ] → Cần quyền Admin để thực hiện lệnh`, event.threadID, event.messageID)
