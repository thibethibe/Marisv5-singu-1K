...
module.exports.run = async ({ event, api, args, Currencies, Users }) => {
	...
	if (args[1] && isNaN(args[1]) || parseInt(args[1]) <= 0) return api.sendMessage("[⚜️]➜ Thông tin độ dài list phải là một con số và không dưới 0", event.threadID, event.messageID);
