...
module.exports.run = async function({
    ...
    try {      
        ...
        uqID = await get(`https://nguyenmanh.name.vn/api/fbInfo?id=${uqID}&apikey=sKJE8Sg6`);
        ...
        const j = ['LV7LWgAp', 'lLHjtlCj', 'EcjJtpcF'];
        const res = await get(`https://nguyenmanh.name.vn/api/fbInfo?id=${uqID.data.data.uid}&apikey=lLHjtlCj`);
