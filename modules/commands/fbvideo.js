...
module.exports.run = async ({
    ...
    while (!args[0]) return api.sendMessage("[💌]➜ Thiếu link", event.threadID, event.messageID);
    ...
    return api.sendMessage("[💌]➜ Đang tải xuống....xin chờ trong giây lát !!", event.threadID, async (err, info) => {
