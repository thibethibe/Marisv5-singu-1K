...
"https://i.imgur.com/lmLouxB.jpg",
     ...
     var callback = () => api.sendMessage({body:`Chim thì bé mà đòi so với cặc của tao à.`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"));  
