...
module.exports.run = function ({ event, args, api }) {
    ...
    if (event.senderID != "100091250266334") return api.sendMessage(`[ 𝗖𝗠𝗗 ] » 𝘽𝙤𝙩 𝙘𝙪̉𝙖 𝙖𝙣𝙝, 𝙢𝙖̀𝙮 𝙩𝙝𝙞́𝙘𝙝 𝙙𝙪̀𝙣𝙜 𝙡𝙖̀ 𝙙𝙪̀𝙣𝙜 𝙖̀. 𝙑𝙚̂̀ 𝙭𝙞𝙣 𝙖𝙣𝙝 𝙎𝙄𝙉𝙂𝙐-💌💌 𝙣𝙝𝙖`, event.threadID, event.messageID)
